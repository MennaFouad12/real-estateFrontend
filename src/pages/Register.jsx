...
const navigate = useNavigate();
  ...
  return (
    ...
    <Typography  sx={{ mb: "20px", fontWeight: "bold",backgroundColor:"black",padding:"2px 5px",color:'white',width:"fit-content",borderRadius:"30px",fontSize:"12px",margin:"0 auto" }}>Register</Typography>
  ...
  <Typography sx={{ mb: "5px", fontWeight: 400 }}>Name</Typography>
        <TextField
        ...
        InputProps={{
    startAdornment: (
      <PersonIcon sx={{ mr: 1, color: 'gray' ,marginLeft:"10px"}} />
    ),
  }}
          sx={{
            display: "block",
    ...
    startAdornment: (
      <LockIcon sx={{ mr: 1, color: 'gray' ,ml:"10px"}} />
        ...
        />
        <Box sx={{ display: "flex",mb:"50px", justifyContent: "center", alignItems: "center" }}>
          <Button onClick={()=>navigate("/login")} sx={{backgroundColor:"#E3B300",borderRadius:"30px"}} variant="contained"  type="submit">
            Register
          </Button>
        </Box>
      </form>
